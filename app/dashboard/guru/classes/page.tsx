        ...
        <div className="space-y-10 pb-20">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium italic uppercase tracking-tighter">Kelola Kelas Tambahan & Bimbingan Anda.</p>
                </div>

                <div className="flex gap-4 w-full md:w-auto">
                    <button
                        onClick={() => setIsCreateModalOpen(true)}
                        className="flex-1 md:flex-none group relative bg-accent hover:bg-orange-600 text-white font-black px-6 py-4 rounded-2xl shadow-lg shadow-orange-500/20 transition-all flex items-center justify-center gap-3 active:scale-95 text-xs uppercase tracking-widest"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {classes.length === 0 && (
                        <div className="col-span-full py-20 text-center">
                            ...
                            <p className="text-slate-500 font-bold italic uppercase tracking-tighter">Anda belum memiliki kelas tambahan.</p>
                        </div>
                    )}
                </div>
            )}
                ...
                {isCreateModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
                        ...
                        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white w-full max-w-md rounded-[2.5rem] p-10 relative z-10 border border-slate-100 shadow-2xl">
                            ...
                            <div className="mb-8">
                                <h3 className="text-2xl font-black text-slate-900 tracking-tight uppercase italic mb-1">Buat Kelas Tambahan</h3>
                            ...
                            <form onSubmit={handleCreateClass} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-4 focus:ring-2 focus:ring-primary/20 outline-none font-bold text-slate-900 italic uppercase tracking-tighter"
                                    />
                                    <p className="text-[10px] text-slate-400 italic mt-1 ml-2">Siswa akan bergabung menggunakan kode yang dihasilkan nanti.</p>
                                </div>
                ...
                {selectedClassForStudent && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
                        ...
                        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white w-full max-w-md rounded-[2.5rem] p-10 relative z-10 border border-slate-100 shadow-2xl">
                            ...
                            <div className="mb-8">
                                <h3 className="text-2xl font-black text-slate-900 tracking-tight uppercase italic mb-1">Tambah Siswa</h3>
                            ...
                            <form onSubmit={handleAssignStudentSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-4 focus:ring-2 focus:ring-primary/20 outline-none font-bold text-slate-900 italic tracking-tighter"
                                    >
                                ...
                                <button
                                    ...
                                    className="w-full py-5 bg-primary text-white rounded-2xl font-black flex items-center justify-center gap-2 mt-4 hover:bg-primary-light transition-all shadow-lg shadow-primary/20 disabled:opacity-50 italic uppercase tracking-widest"
                                >

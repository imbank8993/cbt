            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-6 rounded-3xl shadow-premium border border-slate-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="text-2xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                        ...
                        Pusat Kontrol Bank Soal
                    </h2>
                    <div className="flex flex-col mt-1">
                        <p className="text-slate-500 font-medium text-xs">Otoritas manajemen soal untuk sekolah {org?.name || ''}.</p>
                    </div>
                </div>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2 mb-4 bg-slate-50 p-2 rounded-xl border border-slate-100">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[8px] font-black text-slate-400 uppercase leading-none">Pembuat</span>
                                        <span className="text-[10px] font-bold text-slate-700">{(bank.profiles as any)?.full_name || 'System'}</span>
                                    </div>
                                </div>
